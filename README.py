...
d = """
Im Mehrab Teror
Id Rubika: @Hunter_bug
Chanel Rubika: @Hi_room
Id Telegram : @My_Serverr
Link Gap : https://rubika.ir/joing/BHBEIDFC0NBLFQANCEKMCMJGJBQOVAKR
Ye Ostoreh
"""
...
print (Fore.YELLOW + "")
time.sleep(1.7)
print ("                    I Love You Malake Teror!mn 💜")
...
print (""" !!! Update Script !!!
rm -rf Mehrab Teror
git clone https://github.com/Filtering-Rubika-Ryson/Mehrab-Teror
cd Mehrab Teror
chmod 777 *
python 
